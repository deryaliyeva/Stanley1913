...
function Hero() {
    ...
    return (
        <section className="relative w-full h-[90vh] flex items-end justify-start text-white">
            ...
            <div className="absolute top-[300px] max-lg:top-[40%] max-sm:top-[400px] max-md:top-[60%] bottom-0 left-0 px-[52px] max-md:px-[24px] pb-[40px] max-w-[500px] max-md:max-w-[500px] max-md:min-h-[36px] max-md:leading-[0.1px] text-white">
                <img className="max-w-[187px] min-h-[69px] max-md:max-w-[200px] max-sm:max-w-[118px] max-sm:min-h-[53px] max-md:min-h-[15px] mb-3 max-lg:mt-0" src={heroImg} alt="imgs" />
                ...
                <button className="bg-[#c3001e] w-[164px] h-[48px] py-[14px] px-[32px] text-[16px] rounded-[4px] font-extrabold text-[#fff] mt-[32px] tracking-[1px] hover:bg-[#fff] hover:text-[#101010] cursor-pointer transition-all">
                    SHOP NOW
                </button>
            </div>
        </section>
